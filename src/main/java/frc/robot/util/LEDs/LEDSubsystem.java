...
public class LEDSubsystem extends SubsystemBase {
    ...
    /**
     * This class handles an LED animation, which is a routine for the LEDs where they change
     * with time at some speed. The current state or frame of the animation is sent to the LEDs
     * when the step function is called on the animation, which also moves the animation along one
     * frame.
     */
    public static class LEDAnimation {
         ...
         * 
         * @param speed The speed that the animation goes at. The closer to 0, the slower; the larger,
         * the faster. This changes how much the animation changes when the step function is called.
         * @param animation This is an Integer Consumer object which takes in some number and sets 
         * the corresponding animation state/frame to the LEDs.
         */
        ...
        /**
         * Moves the animation along by an amount dictated by the LEDAnimation object's speed.
         * This sets the LEDs to the current animation frame and then increments the animation
         * accumulation (how far along the animation is).
         */
        public void step() {
        ...
        /**
         * This static method combines any number of LEDAnimations and returns the animation
         * that represents a concatenation of these animations. This new animation will play
         * each animation for a number of frames dictated by the given speed, then move on
         * to the next one, then the next, etc., and then wrap around to the first. Each animation
         * will accumulate when shown.
         * 
         * @param speed The frequency of animation switches. The closer to 0, the longer each animation
         * will show for; the closer to one, the faster; if higher than one, some animations will be
         * skipped or passed over on some passes, depending on the speed and how many animations are given.
         * For example, if the speed is 0.1, it will take 10 calls to step for the next animation to show,
         * if it is 1, then a new animation will show each frame.
         * @param animations The animations to be rotated between, in order.
         * @return The animation corresponding to the concatenation of the given animations.
         */
    ...
    public static class LEDStrip {
        ...
        /**
         * Creates an LEDStrip object to manage an addressable LED strip at a given
         * PWM port with a given LED count.
         * 
         * @param numLights How many LEDs are on the strip, or how many LEDs on a strip should
         * be addressed.
         * @param PWMPort The PWM port that this LED strip is connected to.
         */
         ...
         * 
         * @param speed The speed of the animation (how much each call to step moves
         * the animation along).
        ...
        /**
         * Creates an animation which creates a series of blocks of color of a given length
         * pattern and a given color pattern. The length and color pattern are cycled down the 
         * length of the LED strip separately, which allows for complex patterns. For example, 
         * the blocks might be set to be of size, 1, 2, and 3, repeating, and then the colors
         * might be set to be red and blue (alternating between the two). The animation moves
         * this pattern along the LED strip.
         * 
         * @param speed The speed of the animation (how much each call to step moves
         * the animation along).
         * @param lengthPattern The number of LEDs corresponding to each color block in the pattern.
         * This pattern is repeated along the LED strip.
         * @param colors The colors of the LEDs corresponding to each color block in the pattern.
         * This pattern is repeated along the LED strip.
         * @return The animation corresponding to this pattern moving along the LED strip at some speed.
         */
         ...
         * 
         * @param speed The frequency of color switches. The closer to 0, the longer each color will
         * show for; the closer to one, the faster; if higher than one, some colors will be skipped
         * or passed over on some passes, depending on the speed and how many colors are given.
         * For example, if the speed is 0.1, it will take 10 calls to step for the next color to show,
         * if it is 1, then a new color will show each frame.
         * @param colors The colors to be rotated between, in order.
         * @return The animation corresponding to these colors being cycled between at a given frequency.
         */
        public LEDAnimation blinkingAnimation(double speed, Color... colors) {
        ...
        /**
         * Creates an animation which sets the LEDs to a solid color. When the step function is called,
         * there is no change to the LEDs. If another animation is currently shown on the LEDs, calling
         * the step function of this animation will set the LEDs to be a given solid color.
         * 
         ...
         * @param speed The speed of the animation (how much each call to step moves
         * the animation along).
         * @param steps How many steps are in the fading gradient.
         * @param bidirectional Whether the second color should gradually return to the first color
         * after the first fade occurs (true), or cut back to the first and repeat the fade from the first 
         * to the second color (false).
         * @param c1 The first color in the fade animation.
         * @param c2 The second color in the fade animation.
         ...
         * @param c1 The first color in the fade animation.
         * @param c2 The second color in the fade animation.
         * @return The animation corresponding to a bidirectional fade between two colors.
         */
        public LEDAnimation fadeTwoAnimation(double speed, int steps, Color c1, Color c2) {
        ...
        /**
         * Creates an animation which fades between a number of solid colors in both directions
         * in a given order.
         * 
         * @param speed The speed of the animation (how much each call to step moves
         * the animation along).
         * @param stepsPer How many steps are in the fading gradient.
         * @param colors The colors in the fade animation to be faded between, in order.
        ...
        /**
         * Returns an RGB representation of the light at a given index along the LED strip.
         * 
         ...
         * 
         * @param color The color to be set to the LED strip.
         */
         ...
         * Sets the LED strip to a gradient melding between a number of colors.
         * 
         * @param offset The offset from the default position that the gradient starts at.
         * @param colors The colors that make up the gradient.
         */
        public void setGradient(int offset, Color... colors) {
            Color grad[];
        ...
        /**
         * Sets the LED strip to a series of blocks of color of a given length pattern and
         * a given color pattern. The length and color pattern are cycled down the length
         * of the LED strip separately, which allows for complex patterns. For example, the
         * blocks might be set to be of size, 1, 2, and 3, repeating, and then the colors
         * might be set to be red and blue (alternating between the two).
         * 
         * @param lengths The number of LEDs corresponding to each color block in the pattern.
         * This pattern is repeated along the LED strip.
         * @param colors The colors of the LEDs corresponding to each color block in the pattern.
         * This pattern is repeated along the LED strip.
         */
        ...
        /**
         * Given two colors, this returns a color that is a combination of the two, with some
         * proportion representing how much of the first color to put in over the other.
         * 
         * @param proportion How much of color1 (0 - 1) to use in the combination/interpolation,
         * i.e. how much weight to give to color1 as opposed to color 2.
         * @param color1 The first color to be combined.
         * @param color2 The second color to be combined.
        ...
        /**
         * Creates an array of RGB colors representing a gradient between two given colors
         * over a number of steps.
         * 
         * @param startColor The color to start the gradient at.
         * @param endColor The color to end the gradient at.
         * @param steps The number of steps/individual colors in the gradient, i.e. the 
         * smoothness/length of the gradient.
         * @return An array of RGB colors representing a gradient between the two given colors.
         */
    ...
    /**
     * A dummy constructor. This is necessary in order to create commands around the LEDs and
