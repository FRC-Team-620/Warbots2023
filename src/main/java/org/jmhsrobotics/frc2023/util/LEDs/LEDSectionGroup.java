...
/**
 * Combines a number of LED sections from the SectionManager such that
 * they can be written to as though they were one section, even if they
 * are far apart from one another. This allows, for example, animations
 * to loop through them as though they were one larger or combined section.
 */
public class LEDSectionGroup extends LEDBuffer {
	...
	/**
	 * Creates an LEDSectionGroup combining the given LED sections from
	 * the SectionManager.
	 * 
	 * @param sections The LED sections to be combined
	 */
