...
public class SimPipeLineVisionSystem {
	...
	public SimPipeLineVisionSystem(String camName, double camDiagFOVDegrees, Transform3d robotToCamera,
	...
	public int addPipeline() {
		...
		systems.add(new SimVisionSystemFixed(camName, camDiagFOVDegrees, robotToCamera, maxLEDRangeMeters,
