					...
					case FLOOR :
						addCommands(new ConditionalCommand(
								...
								new ParallelCommandGroup(
										new CommandIntakeSolenoid(robotContainer.getIntakeSubsystem(), true),
										new CommandAWThenE(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(),
												0.8, 45, 90, robotContainer.getControlBoard().override())),
								robotContainer.getArmSubsystem()::isCone));
						break;
					case MID :
						addCommands(new ConditionalCommand(
								new CommandAThenEW(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(), 1.0, 95,
										90, robotContainer.getControlBoard().override()),
								new CommandAThenEW(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(), 1.0, 80,
										90, robotContainer.getControlBoard().override()),
								robotContainer.getArmSubsystem()::isCone));
						break;
					case HIGH :
				...
				switch (setpoint) {
					case STOWED :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(new CommandEThenAW(robotContainer.getArmSubsystem(),
										...
										WristConstants.stowedPositionAbsolute, robotContainer.getControlBoard().override())),
								new ParallelCommandGroup(new CommandEThenAW(robotContainer.getArmSubsystem(),
										robotContainer.getWristSubsystem(), 0.0, ArmConstants.stowedDegrees,
										WristConstants.stowedPositionAbsolute, robotContainer.getControlBoard().override())),
								robotContainer.getArmSubsystem()::isCone));
					...
					case FLOOR :
						addCommands(new ConditionalCommand(
								...
								new ParallelCommandGroup(
										new CommandAWThenE(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(),
												0.8, 35, 65, robotContainer.getControlBoard().override())),
								robotContainer.getArmSubsystem()::isCone));
						break;
					case MID :
						addCommands(new ConditionalCommand(
					...
					case HIGH :
						addCommands(new ConditionalCommand(
								new CommandAWThenE(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(), 1.0, 110,
										138, robotContainer.getControlBoard().override()),
								new CommandAWThenE(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(), 1.0, 110,
										138, robotContainer.getControlBoard().override()),
					...
					case PICKUP :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(),
												0.0, 50, 140, robotContainer.getControlBoard().override())),
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.getArmSubsystem(), robotContainer.getWristSubsystem(),
												0.0, 67, 140, robotContainer.getControlBoard().override())),
								robotContainer.getArmSubsystem()::isCone));
						break;
					default :
						break;
