		...
		switch (gripperType) {
				...
				switch (setpoint) {
					case STOWED :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										...
										new CommandEThenAW(robotContainer.armSubsystem, robotContainer.wristSubsystem,
					...
					case FLOOR :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										new CommandIntakeSolenoid(robotContainer.intakeSubsystem, false),
										new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.8, 66, 90, robotContainer.controlBoard.override())),
								new ParallelCommandGroup(
										new CommandIntakeSolenoid(robotContainer.intakeSubsystem, true),
										new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.8, 45, 90, robotContainer.controlBoard.override())),
								robotContainer.armSubsystem::isCone));
						break;
					case MID :
						addCommands(new ConditionalCommand(
								new CommandAThenEW(robotContainer.armSubsystem, robotContainer.wristSubsystem, 1.0, 95,
										90, robotContainer.controlBoard.override()),
								new CommandAThenEW(robotContainer.armSubsystem, robotContainer.wristSubsystem, 1.0, 80,
										90, robotContainer.controlBoard.override()),
								robotContainer.armSubsystem::isCone));
						break;
					case HIGH :
					...
					case PICKUP :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.0, 67, 120, robotContainer.controlBoard.override()),
										new CommandIntakeSolenoid(robotContainer.intakeSubsystem, false)),
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.0, 67, 120, robotContainer.controlBoard.override()),
			...
			case MOTOR :
				switch (setpoint) {
					case STOWED :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(new CommandEThenAW(robotContainer.armSubsystem,
										robotContainer.wristSubsystem, 0.0, ArmConstants.stowedDegrees,
					...
					case FLOOR :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										new CommandIntakeSolenoid(robotContainer.intakeSubsystem, false),
										new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.0, 43, 60, robotContainer.controlBoard.override())),
								new ParallelCommandGroup(
										new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.8, 35, 65, robotContainer.controlBoard.override())),
								robotContainer.armSubsystem::isCone));
						break;
					case MID :
						addCommands(new ConditionalCommand(
					...
					case HIGH :
						addCommands(new ConditionalCommand(
								new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem, 1.0, 110,
										138, robotContainer.controlBoard.override()),
								new CommandAWThenE(robotContainer.armSubsystem, robotContainer.wristSubsystem, 1.0, 110,
										138, robotContainer.controlBoard.override()),
					...
					case PICKUP :
						addCommands(new ConditionalCommand(
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.0, 50, 140, robotContainer.controlBoard.override())),
								new ParallelCommandGroup(
										new CommandEThenAW(robotContainer.armSubsystem, robotContainer.wristSubsystem,
												0.0, 67, 140, robotContainer.controlBoard.override())),
								robotContainer.armSubsystem::isCone));
						break;
					default :
						break;
