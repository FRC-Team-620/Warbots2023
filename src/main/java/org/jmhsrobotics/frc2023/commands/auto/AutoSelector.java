...
// SendableChooser<DriverStation.Alliance> teamSelector = new
// SendableChooser<>();
...
// container.getLEDSubsystem()));
// autoSelector.addOption("StartingDistanceAuto", new
// StartingDistanceAuto(container.getDrivetrain()));
